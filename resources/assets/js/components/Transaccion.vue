                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <select
                                        ...
                                        v-model="criterio"
                                    >
                                        <option value="tipoTransacciones"
                                            >Tipo de Transacciones</option
                                        >
                                        <option value="formaPagoTransacciones"
                        ...
                        <div class="table-responsive">
                            ...
                            >
                                ...
                                <tbody class="text-center">
                                    <tr
                                        v-for="transaccion in arrayTransacciones"
                                    ...
                                    >
                                        ...
                                        <td
                                            v-text="
                                                transaccion.observacionTransacciones
                                            "
                                        ></td>
                                        <td
                                            v-text="
                                        ...
                                        <td>
                                            <button
                                                ...
                                                "
                                                class="btn btn-succes btn-sm btnvisualizar"
                                            >
                                                <i class="icon-eye"></i>
                                            </button>
                                            &nbsp;
                    ...
                    <div class="card-body">
                        <div class="form-group row border">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select
                                        class="form-control"
                                        v-model="formaPagoTransacciones"
                                    >
                                        <option value="0">Seleccione</option>
                        ...
                        <div class="form-group row border">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <button
                                        class="btn btn-succes form-control btnagregar"
                                    >
                                        <i class="icon-plus"></i>
                                    </button>
                                </div>
...
export default {
    ...
    methods: {
        ...
        validarProducto() {
            ...
            if (!this.stockProductos)
                this.errorMsjProducto.push("El stock debe ser un número");
